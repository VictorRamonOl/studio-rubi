  ...
  return (
    <html lang="pt-BR" className={`${playfair.variable} ${inter.variable}`}>
      <head>
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-9MRPRX09Y5" />
        <script dangerouslySetInnerHTML={{ __html: `window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments)}gtag('js',new Date());gtag('config','G-9MRPRX09Y5');gtag('config','AW-18083053978');` }} />
